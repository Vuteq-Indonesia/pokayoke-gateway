    ...
    "A": [
        {
            ...
            "reg": (
                ...
                else "D144" if i in [3, 10, 9]
                else "D146" if i in [24, 17,23]
            ...
            "button": (
                ...
                else "D1104" if i in [3, 10,9]
                else "D1106" if i in [24, 17, 23]
            ...
            "lamp": (
                ...
                else "D1105" if i in [3, 10,9]
                else "D1107" if i in [23, 17, 23]
    ...
    "AA": [
        {
            "code": f"AA{i}",
            "reg":(
                "D122" if i in [1,3,5,10,7,4]
                else "D180" if i in [2,8,9,6]
                else None
            ) ,
            "button": (
                "D1042" if i in [1,3,5,10,7,4]
                else "D1200" if i in [2,8,9,6]
                else None
            ),
            "lamp": (
                "D1052" if i in [1, 3, 5, 10,7,4]
